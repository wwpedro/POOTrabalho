...
public class ConexaoBanco {
        ...
        public void cadastrar_dados(Produtos Produtos) throws SQLException {
                dados.conectar();
                ...
                stmt.setString(8, Produtos.getToxicidade1());
                stmt.setString(9, Produtos.getDano1());
                stmt.setDouble(10, Produtos.getTemperatura1());
                stmt.setInt(11, Produtos.getQntconservantes1());
                stmt.execute();
